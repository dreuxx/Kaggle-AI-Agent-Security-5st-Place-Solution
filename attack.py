...
def _gemma_url(i: int) -> str:
    ...
    label = _label(i)
    label = {
        "gq": _label(HARD_N_CAP),
        "ac": _label(HARD_N_CAP + 1),
        "dl": _label(HARD_N_CAP + 2),
        "do": _label(HARD_N_CAP + 3),
        "kv": _label(HARD_N_CAP + 4),
        "lr": _label(HARD_N_CAP + 5),
        "or": _label(HARD_N_CAP + 6),
        "rr": _label(HARD_N_CAP + 7),
    }.get(label, label)
    return f"://{label}"
